...
compressor() {
    ...
    case "$user_ext" in
            ...
            7z|rar)
                ...
                echo -e "${GREEN}Created $(echo "$user_ext" | tr '[:lower:]' '[:upper:]') archive:${RESET} $archive"
                ;;
            ...
            *)
                ...
                echo -e "Valid extensions: zip, 7z, rar, tar, tar.gz (gz/tgz), tar.zst (zst/tzst), tar.xz (xz/txz)"
                exit 1
                ;;
    esac
